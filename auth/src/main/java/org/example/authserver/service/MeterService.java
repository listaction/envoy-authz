...
public class MeterService {
  ...
  private void init() {
    counters.put(REQUESTS_HITS_CACHE, Counter.builder(REQUESTS_HITS_CACHE).register(meterRegistry));
    counters.put(
        REQUESTS_HITS_ZANZIBAR, Counter.builder(REQUESTS_HITS_ZANZIBAR).register(meterRegistry));
  }
