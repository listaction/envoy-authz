...
public class AclService {
    ...
    public void delete(String namespace, String object, String relation, String user, String usersetNamespace, String usersetObject, String usersetRelation) {
        repository.deleteAllByNamespaceAndObjectAndRelationAndUserAndUsersetNamespaceAndUsersetObjectAndUsersetRelation(namespace, object, relation, user, usersetNamespace, usersetObject, usersetRelation);
    }
    public void delete(Acl acl) {
        delete(acl.getNamespace(), acl.getObject(), acl.getRelation(), acl.getUser(), acl.getUsersetNamespace(), acl.getUsersetObject(), acl.getUsersetRelation());
    }
}
