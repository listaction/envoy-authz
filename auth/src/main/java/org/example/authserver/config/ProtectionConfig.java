...
public class ProtectionConfig {
    ...
    FilterRegistrationBean<MappingsPasswordFilter> mappingsPasswordFilter () {
        final FilterRegistrationBean<MappingsPasswordFilter> filterFilterRegistrationBean = new FilterRegistrationBean<>();
        filterFilterRegistrationBean.setFilter(new MappingsPasswordFilter(properties));
        filterFilterRegistrationBean.addUrlPatterns("/mapping/create", "/mapping/create-many", "/mapping/clear", "/mapping/delete/**", "/mapping/list");
